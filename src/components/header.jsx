...
const Header = ({ section }) => {
  return (
    <header className="header ">
      <nav className="nav h-15 flex bg-gray-400 justify-between items-center pr-2">
        <img className="images h-10 rounded-2xl ml-2" src={images} alt="image" />
        <div className="desktop-navigation  hidden lg:flex">
          <ul className="flex justify-between px-8 gap-5 font-serif">
          ...
          <div className="login font-serif ">
            ...
            <button className="bg-amber-800  hover:bg-blue-900 ml-2 w-15 rounded-2xl">Click</button>
          </div>
        </div>
